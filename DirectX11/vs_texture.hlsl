...
PixelInputType main(VertexInputType input)
{
    ...
    // The only difference in the texture vertex shader in comparison to the color vertex shader from the previous tutorial is that instead
    // of taking a copy of the color from the input vertex we take a copy of the texture coordinates and pass them to the pixel shader.
