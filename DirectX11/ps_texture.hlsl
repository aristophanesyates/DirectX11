...
// texture still looks decent on the really small polygon face.
// We will setup the sampler state in the TextureShaderClass also and then attach it to the resource pointer so this pixel shader can 
// use it to determine which sample of pixels to draw.
/////////////
// GLOBALS //
/////////////
